...
function getSlotMetrics(_ref2) {
  ...
  return {
    ...
    closestGroupFromPoint: function closestGroupFromPoint(
      point,
      boundaryRect,
      groups
    ) {
      var _document, _document$getElements, _groups$Math$floor
      var gutterWidth = 93
      var scrollLeft =
        ((_document = document) === null || _document === void 0
          ? void 0
          : (_document$getElements =
              _document.getElementsByClassName('rbc-time-content')[0]) ===
              null || _document$getElements === void 0
          ? void 0
          : _document$getElements.scrollLeft) || 0
      return (_groups$Math$floor =
        groups[
          Math.floor((scrollLeft + boundaryRect.left - gutterWidth) / 300)
        ]) === null || _groups$Math$floor === void 0
        ? void 0
        : _groups$Math$floor.id
    },
